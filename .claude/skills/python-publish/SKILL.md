---
name: python-publish
description: Guidelines to publish Python packages
...
instruct the user to log into PyPI and add a new publisher at
...
Instruct the user to add a new tagged commit and push it to the repository.
