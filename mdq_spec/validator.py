...
class ValidationResult:
    ...
    #: mdq_spec.linter). These never affect `valid` -- they're advisory,
    #: not hard failures.
...
def validate_document(
    ...
    mdq_spec.linter checks (`result.warnings`) for problems that require
    ...
    mdq_spec.linter for details. Invalid values raise ValueError.
    """
